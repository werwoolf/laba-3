...
/// TaskResultResponse : Represents the result of a task, including completion details and submitted form data.
...
impl TaskResultResponse {
    /// Represents the result of a task, including completion details and submitted form data.
    pub fn new(id: i32, task_id: i32, completed_by_user_id: i32, completion_date: String, result: models::TaskResult, form_results: serde_json::Value, created_at: String) -> TaskResultResponse {
        TaskResultResponse {
            id,
            task_id,
