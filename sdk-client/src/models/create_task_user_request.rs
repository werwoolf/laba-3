...
/// CreateTaskUserRequest : Request body for assigning users to a task.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CreateTaskUserRequest {
...
impl CreateTaskUserRequest {
    /// Request body for assigning users to a task.
    pub fn new(task_id: i32, user_ids: Vec<i32>) -> CreateTaskUserRequest {
